                      ...
                      <table class="schedule-table">
                        <tbody>
                          <tr :class="isTime(block.b1_start) ? 'active':''">
                            ...
                            <td><div class="schedule-watch-now"><a :href="profiles[getGameIdByName(block.b1_name)].twitch">Watch now!<br /> <img class="schedule-twitch-logo" src="./assets/img/Twitch2.svg" /></a></div></td>
                          </tr>
                          <tr :class="isTime(block.b2_start) ? 'active':''">
                            ...
                            <td><div class="schedule-watch-now"><a :href="profiles[getGameIdByName(block.b2_name)].twitch">Watch now!<br /> <img class="schedule-twitch-logo" src="./assets/img/Twitch2.svg" /></a></div></td>
                          </tr>
                          <tr :class="isTime(block.b3_start) ? 'active':''">
                            ...
                            <td><div class="schedule-watch-now"><a :href="profiles[getGameIdByName(block.b3_name)].twitch">Watch now!<br /> <img class="schedule-twitch-logo" src="./assets/img/Twitch2.svg" /></a></div></td>
                          </tr>
                          <tr :class="isTime(block.b4_start) ? 'active':''">
                            ...
                            <td><div class="schedule-watch-now"><a :href="profiles[getIdByName(block.b4_name)].twitch">Watch now!<br /> <img class="schedule-twitch-logo" src="./assets/img/Twitch2.svg" /></a></div></td>
                          </tr>
                          <tr :class="isTime(block.b5_start) ? 'active':''">
                            ...
                            <td><div class="schedule-watch-now"><a :href="profiles[getIdByName(block.b5_name)].twitch">Watch now!<br /> <img class="schedule-twitch-logo" src="./assets/img/Twitch2.svg" /></a></div></td>
                          </tr>
                        </tbody>
                      </table>
                    </swiper-slide>        
